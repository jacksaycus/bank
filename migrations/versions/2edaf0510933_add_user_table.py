...
Revision ID: 2edaf0510933
Revises: 
Create Date: 2025-10-11 05:56:50.581105
...
def upgrade() -> None:
    ...
    sa.Column('role', sa.Enum('CUSTOMER', 'ACCOUNT_EXECUTIVE', 'BRANCH_MNANGER', 'ADMIN', 'SUPER_ADMIN', 'TELLER', name='rolechoicesschema'), nullable=False),
