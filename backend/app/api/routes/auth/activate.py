...
async def activate_user(
    ...
    try:
        ...
        if error_msg == "Actiovation token expired":
            raise HTTPException(
                status_code=status.HTTP_410_GONE,
                detail={
                    "status": "error",
                    "message": "Activation link has expired",
                    "action": "Please request a new activatino link",
        ...
        try:
            ...
            if not user:
                raise HTTPException(
                    ...
                    detail={
                        "status": "error",
                        "message": "If an account exists with this email, please check your index for the activation link",
                    },
                )
            ...
            return {
                "message": "If an account exists with this email, please check your inbox the activation link"
            }
        except HTTPException as http_ex:
            raise http_ex
        except Exception as e:
            ...
            raise HTTPException(
                ...
                detail={
                    "status": "error",
                    "mesage": "Failed to resend activation link",
